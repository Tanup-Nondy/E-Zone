...
@section('content')
	...
	<main class="col-sm-9 ml-sm-auto col-md-10 pt-4" style="text-decoration: underderline;">
		<h3>Add Naw Product</h3>
		<div class="col-md-6">
			<div class="panel-body">
				<form action="/admin/product/store" method="post" role="form" enctype="multipart/form-data">
					{{csrf_field()}}
					...
					<div class="form-group{{$errors->has('spl_price')? 'has-error':''}}">
						<label for="spl_price">Special Price</label>
						<input type="text" class="form-control" name="spl_price" id="spl_price" placeholder="Enter Special Price">
